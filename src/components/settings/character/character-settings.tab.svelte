<script lang="ts">
  ...
  async function loadFromLlm(action: string) {
    ...
    const mapping: any = {
      ...
      goal: { prompt: CharCreatePrompts.goal, key: "goals" },
...
<span class="leading-none text-sm"
  >Use these boxes to form a reason for your cunt to exist. These will be injected into the prompt however, you can ultimately change the
  prompt in LLMSettings. Follow this, don't follow this. Who cares.</span
>
