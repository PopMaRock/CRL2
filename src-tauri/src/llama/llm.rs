use crate::llama::sampler_config::{make_sampler, SamplerConfig};
...
pub enum InitWorkerError {
    ...
    ChatTemplateError(#[from] crate::llama::chat_state::FromModelError),
...
mod tests {
    ...
    fn test_stop_tokens() -> Result<(), Box<dyn std::error::Error>> {
        crate::llama::test_utils::init_test_tracing();
