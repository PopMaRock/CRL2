...
use crate::llama::chat_state;
use crate::llama::chat_state::ChatState;
use crate::llama::llm;
use crate::llama::llm::Worker;
use crate::llama::sampler_config::SamplerConfig;
...
impl ChatHandle {
    ...
    pub async fn get_chat_history_async(&self) -> Vec<crate::llama::chat_state::Message> {
        let mut rx = self.get_chat_history();
        rx.recv().await.unwrap_or_default()
    }

    /// Get a receiver for the chat history (lower-level API).
    pub fn get_chat_history(&self) -> tokio::sync::mpsc::Receiver<Vec<crate::llama::chat_state::Message>> {
    ...
    pub async fn set_chat_history_async(&self, messages: Vec<crate::llama::chat_state::Message>) {
    ...
    pub fn set_chat_history(
        &self,
        messages: Vec<crate::llama::chat_state::Message>,
...
enum ChatMsg {
    ...
    GetChatHistory {
        output_tx: tokio::sync::mpsc::Sender<Vec<crate::llama::chat_state::Message>>,
    },
    SetChatHistory {
        messages: Vec<crate::llama::chat_state::Message>,
...
impl<'a> Worker<'_, ChatWorker> {
    ...
    pub fn set_chat_history(&mut self, messages: Vec<crate::llama::chat_state::Message>) {
        self.reset_context();
        ...
        worker
            .say(
                "I would like to know the temperature in two cities: Copenhagen and Beijing."
                    .into(),
                crate::llama::sampler_config::SamplerConfig::default(),
                vec![],
                f,
            )
            .expect("fuck");
